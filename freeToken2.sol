...
contract FreeToken is ERC20Detailed, Ownable {
    ...
    constructor(address _swapRouter,address _freeDaoAddress,address _autoLiquidityReceiver,address _firePit,address _usdt) ERC20Detailed(_name,_symbol, uint8(DECIMALS)) Ownable() {
